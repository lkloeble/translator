...
public class BereshitBridgeTest extends TranslatorBridgeTest {
    ...
    String hebrewPathFile = localTestPath + "bereshit_content.txt";
    String hebrewResultFile = localTestPath + "bereshit_expected_results.txt";

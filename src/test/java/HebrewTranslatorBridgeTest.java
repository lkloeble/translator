...
public class HebrewTranslatorBridgeTest extends TranslatorBridgeTest {
    ...
    public void test_weingreen_chapter_17() {
        checkInMaps("wein17A", translatorBridge);
        checkInMaps("wein17B", translatorBridge);
        checkInMaps("wein17C", translatorBridge);
        checkInMaps("wein17D", translatorBridge);
        checkInMaps("wein17E", translatorBridge);
        checkInMaps("wein17G", translatorBridge);
        checkInMaps("wein17H", translatorBridge);
        checkInMaps("wein17I", translatorBridge);
        checkInMaps("wein17J", translatorBridge);
        checkInMaps("wein17K", translatorBridge);
        checkInMaps("wein17L", translatorBridge);
        checkInMaps("wein17M", translatorBridge);
        checkInMaps("wein17N", translatorBridge);
        checkInMaps("wein17O", translatorBridge);
        checkInMaps("wein17P", translatorBridge);
        checkInMaps("wein17Q", translatorBridge);
        checkInMaps("wein17R", translatorBridge);
        checkInMaps("wein17S", translatorBridge);
        checkInMaps("wein17T", translatorBridge);
        checkInMaps("wein17U", translatorBridge);
        checkInMaps("wein17V", translatorBridge);
        checkInMaps("wein17W", translatorBridge);
        checkInMaps("wein17X", translatorBridge);
        checkInMaps("wein17Y", translatorBridge);
    }

    @Test
    public void test_weingreen_chapter_18() {
        checkInMaps("wein18A", translatorBridge);
        checkInMaps("wein18B", translatorBridge);
        checkInMaps("wein18C", translatorBridge);
        checkInMaps("wein18D", translatorBridge);
        checkInMaps("wein18E", translatorBridge);
        checkInMaps("wein18F", translatorBridge);
        checkInMaps("wein18G", translatorBridge);
        checkInMaps("wein18H", translatorBridge);
        checkInMaps("wein18I", translatorBridge);
        checkInMaps("wein18J", translatorBridge);
        checkInMaps("wein18K", translatorBridge);
        checkInMaps("wein18L", translatorBridge);
        checkInMaps("wein18M", translatorBridge);
        checkInMaps("wein18N", translatorBridge);
        checkInMaps("wein18O", translatorBridge);
        checkInMaps("wein18P", translatorBridge);
        checkInMaps("wein18Q", translatorBridge);
        checkInMaps("wein18R", translatorBridge);
        checkInMaps("wein18S", translatorBridge);
        checkInMaps("wein18T", translatorBridge);
        checkInMaps("wein18U", translatorBridge);
    }
    ...
    public void test_weingreen_chapter_20() {
        checkInMaps("wein20A", translatorBridge);
        checkInMaps("wein20B", translatorBridge);
        checkInMaps("wein20C", translatorBridge);
        checkInMaps("wein20D", translatorBridge);
        checkInMaps("wein20E", translatorBridge);
        checkInMaps("wein20F", translatorBridge);
        checkInMaps("wein20G", translatorBridge);
        checkInMaps("wein20H", translatorBridge);
        checkInMaps("wein20I", translatorBridge);
        checkInMaps("wein20J", translatorBridge);
        checkInMaps("wein20K", translatorBridge);
        checkInMaps("wein20L", translatorBridge);
        checkInMaps("wein20M", translatorBridge);
        checkInMaps("wein20N", translatorBridge);
        checkInMaps("wein20O", translatorBridge);
        checkInMaps("wein20P", translatorBridge);
        checkInMaps("wein20Q", translatorBridge);
        checkInMaps("wein20R", translatorBridge);
        checkInMaps("wein20S", translatorBridge);
        checkInMaps("wein20T", translatorBridge);
        checkInMaps("wein20U", translatorBridge);
    }
    ...
    public void test_weingreen_chapter_22() {
        checkInMaps("wein22A", translatorBridge);
        checkInMaps("wein22B", translatorBridge);
        checkInMaps("wein22C", translatorBridge);
        checkInMaps("wein22D", translatorBridge);
        checkInMaps("wein22E", translatorBridge);
        checkInMaps("wein22F", translatorBridge);
        checkInMaps("wein22G", translatorBridge);
        checkInMaps("wein22H", translatorBridge);
        checkInMaps("wein22I", translatorBridge);
        checkInMaps("wein22J", translatorBridge);
        checkInMaps("wein22K", translatorBridge);
        checkInMaps("wein22L", translatorBridge);
        checkInMaps("wein22M", translatorBridge);
        checkInMaps("wein22N", translatorBridge);
        checkInMaps("wein22O", translatorBridge);
        checkInMaps("wein22P", translatorBridge);
        checkInMaps("wein22Q", translatorBridge);
        checkInMaps("wein22R", translatorBridge);
        checkInMaps("wein22S", translatorBridge);
        checkInMaps("wein22T", translatorBridge);
        checkInMaps("wein22U", translatorBridge);
        checkInMaps("wein22V", translatorBridge);
        checkInMaps("wein22W", translatorBridge);
        checkInMaps("wein22X", translatorBridge);
        checkInMaps("wein22Y", translatorBridge);
        checkInMaps("wein22Z", translatorBridge);

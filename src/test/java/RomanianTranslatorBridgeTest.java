...
public class RomanianTranslatorBridgeTest extends TranslatorBridgeTest {
    ...
    public void test_boca4() {
        ...
        checkInMaps("bocaseumpluA141", translatorBridge);
        checkInMaps("bocaseumpluA142", translatorBridge);
    }
    ...
    @Test
    public void test_patericul7() {
        checkInMaps("patericulegyptantonia7A", translatorBridge);

...
public class VokalizedHebrewTranslatorBridgeTest extends TranslatorBridgeTest {
    ...
    private List<String> getNouns() {
        ...
        return Arrays.asList(new String[]{
                ...
                "awr'h@masc%im-ot",
                "awrita@neut%invpur",
                "awt@fem%custom(nomplr=awtiwt)",
                "awt@masc%custom(nomplr=awtwt)",
                "a'h@masc%im",
    ...
    private List<String> getHebDico() {
        return Arrays.asList(new String[]{
                ...
                "amn@verb!norm%1(verb)=faireconfiance",
                "amr@verb!norm%1(verb)=dire",
                "aw331r@noun!invfem%1(noun)=flamme,feu%2(noun)=lumière",
                "awrita@noun!invpur%1(noun)=torah",
                "awr'h@noun!im-ot%1(noun)=invité%2(noun)=hôte",
                "awt@noun!custom(nomplr=awtiwt)%1(noun)=lettre",
                "awt@noun!custom(nomplr=awtwt)%1(noun)=signe",
                ...
                "brii'@noun!invpur%1(noun)=beraitha",
                "b56r64k64@noun!ot%1(noun)=bénédiction",
                "brkwt@noun!invpur%1(noun)=berakot (traité)",
                ...
                "drsh@noun!invpur%1(noun)=interprétation",
                ...
                "hqbhexpr@noun!invpur%1(noun)=SaintBéniSoitIl",
                ...
                "'hzlexpr@noun!invpur%1(noun)='hazal (sages de bienheureuse mémoire)",
                "'hi@noun!im-ot%1(noun)=vivant",
                "'hidaexpr@noun!invpur%1(noun)='hida (rabbin azoulay)",
                ...
                "kdi@prep%1(prep)=quand%2(prep)=afin de%3(prep)=pour%4(prep)=selon",
                ...
                "mawr@noun!custom(nomplr=mart)%1(noun)=luminaire",
                "mawr@noun!ot%1(noun)=repaire",
                "mwyd@noun!im%1(noun)=fête",
                "mh@prep%1(prep)=quoi",
                "m63h@prep%1(prep)=quoi",
                "m64h@prep%1(prep)=quoi",
                "mi@prep%1(prep)=qui",
                "m60i@prep%1(prep)=qui",
                "milta@noun!invpur%1(noun)=chose%2(noun)=mot",
                ...
                "mspx@noun!im%1(noun)=justice%2(noun)=juge%3(noun)=jugement",
                ...
                "nsa@verb!norm%1(verb)=porter",
                "pdgwg@noun!im%1(noun)=pédagogue",
                "pi'@noun!invpur%1(noun)=paracha",
                ...
                "prs@verb!norm%1(verb)=interpreter",
                ...
                "qdm@verb!norm%1(verb)=preceder",
                "qwdm@prep%1(prep)=d'abord",
                ...
                "qmlexpr@noun!invpur%1(noun)=il nous enseigne",
                ...
                "rashiexpr@noun!invpur%1(noun)=rashi",
                ...
                "sbt@noun!invpur%1(noun)=shabbat",
                ...
                "sn@noun!im-fem%1(noun)=année",
                "sni@noun!invpur%1(noun)=second",
                "spx@verb!norm%1(verb)=juger",
    ...
    private List<String> getVerbs() {
        return Arrays.asList(new String[]{
                ...
                "zkr,,[paal],(IPR%substitute%zk*zwk*0@AIF%alternateaccentuation%zkr*zkwr*)",

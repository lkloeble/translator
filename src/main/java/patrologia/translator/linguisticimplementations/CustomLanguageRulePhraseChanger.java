...
public abstract class CustomLanguageRulePhraseChanger {
    ...
    protected Phrase splitBeginPrepositionAndVerbForm(Phrase phrase, Preposition preposition, String verbForm, VerbRepository2 verbRepository) {
        Set<Integer> integers = phrase.keySet();
    ...
    protected boolean verbFormStartsWithPreposition(Word word, Preposition preposition, String verbForm, VerbRepository2 verbRepository) {

...
public class EnglishAnalyzer  implements Analyzer {
    ...
    public EnglishAnalyzer(PrepositionRepository prepositionRepository, NounRepository nounRepository, VerbRepository2 verbRepository) {
    ...
    private Phrase affectConjugationWithVerbIs(Phrase phrase) {
        ...
        for(Integer indice : indices) {
            ...
            if(nextVerb.getInitialValue().endsWith("ed")) {
                nextVerb.setConjugation(Conjugation2.PAST_PARTICIPE);
            }
            nextVerb.addForbiddenConjugation(Conjugation2.ACTIVE_IMPERATIVE_PRESENT);
            nextVerb.addForbiddenConjugation(Conjugation2.INFINITIVE);
        }
        return phrase;
    }
    ...
    private Phrase splitVerbNegationIntoSingleWord(Phrase phrase) {
        ...
        for(Integer indice : integers) {
            ...
            if(initialValue.endsWith("n't")) {
                ...
                verb.addForbiddenConjugation(Conjugation2.INFINITIVE);
                verb.addForbiddenConjugation(Conjugation2.ACTIVE_IMPERATIVE_PRESENT);

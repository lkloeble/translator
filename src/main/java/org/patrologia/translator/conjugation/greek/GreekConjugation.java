 ...
 * AORPASSINF => AORist PASSive INFinitive
 *
 */
public class GreekConjugation extends Conjugation {

    protected static List<String> times = Arrays.asList(new String[]{"IPR","AII","ACAOIM","ACAOIN","ACAOINBIS","PEACINF","PEACIND","PRPARPASS","PII","ACOPPR","PAAOIM","MIAOIN","PAINPRAC","PEPASPAR","AORPASOPT","AORPASIND","AORACTINF","PASANT","AORPASSPART","PARAORINFACT","AORPASDEP","PARAORINFPAS","AORPASSPART","ACAOOP","AORMIDDIND","FUTPARTACT","IMPMIDPASSIND","PRESACTPART","PRMIDPASSDEPPART","PRESPASPART","PERACTPAR","PRMIDPASSPART","MIDPASSSUBJPRE","AORACTPART","PIP","PERFMIDPASSINDI","MIDPASSPLUPERFIND","PRESPASSINF","PERFMIDPASSSUBJ","PERFACTIND","AORACTSUBJ","PERFMIDPART","MIDPASSIMP","MIDDPASSIND","AORPASSINF"});

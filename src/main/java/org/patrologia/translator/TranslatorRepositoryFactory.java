...
import patrologia.translator.basicelements.modifier.GreekFinalModifier;
...
import patrologia.translator.linguisticimplementations.*;
...
public class TranslatorRepositoryFactory {
    ...
    public TranslatorRepositoryFactory(VerbRepository verbRepository, NounRepository nounRepository) {

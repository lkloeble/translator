...
import org.patrologia.translator.rule.greek.RulePlurialNeutralWithSingularVerbMustChangeTimeVerbToPlural;
 ...
 */
public class GreekAnalyzer implements Analizer {
    ...
    private String skipAccentuetedCharacters(String sentence) {
        ...
        int[] charsz = new int[]{7936,7938,7940,7941,7952,7953,7955,7956,7969,7971,7973,7974,7975,7984,7988,7990,8000,8001,8003,8004,8005,8016,8017,8019,8020,8021,8023,8033,8036,8037,8039,8048,8049,8050,8051,8052,8053,8054,8055,8056,8057,8058,8059,8061,8103,8118,8127,8134,8135,8147,8150,8166,8179,8182,8183};
        for (char c : chars) {
            int i = (int) c;
